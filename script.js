...
// If modal doesn't exist, STOP (prevents errors)
if (modal && modalImage && modalVideo && modalCaption && closeModal) {

    // Add click listeners to all gallery items
    document.querySelectorAll(".scroll-row img, .scroll-row video").forEach(item => {
